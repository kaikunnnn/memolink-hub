  ...
  return <section className={`relative overflow-hidden ${className}`}>
      ...
      <div className="container-wide relative pt-32 pb-20 md:pt-40 md:pb-32">
        <div className="max-w-3xl mx-auto text-center">
          <div className="inline-block chip animate-fade-in bg-primary/10 text-primary font-medium mb-4" style={{
          animationDelay: '0.2s'
        }}>
            新しい学びの形
          </div>
          
          <h1 className="heading-1 mb-6 animate-fade-up" style={{
          animationDelay: '0.3s'
        }}>
          ...
          animationDelay: '0.5s'
            ...
            <Button size="lg" className="relative overflow-hidden group w-full sm:w-auto" asChild onMouseEnter={() => setIsHovered(true)} onMouseLeave={() => setIsHovered(false)}>
              <Link to="/signup">
        ...
        {/* Stats */}
        <div className="mt-16 md:mt-24 grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8 max-w-4xl mx-auto animate-fade-up" style={{
        animationDelay: '0.6s'
      }}>
          {[{
          value: '200+',
          ...
          value: '98%',
          label: '満足度'
        }].map((stat, index) => <div key={index} className="text-center p-4 bg-white/50 dark:bg-white/5 backdrop-blur-sm rounded-xl border border-border/50">
